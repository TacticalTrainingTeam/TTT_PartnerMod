...
- **README.md** — update the Features section if the change affects features or usage.
- **PR label** — apply the matching `changelog/*` label so release-drafter includes it in the drafted release notes.
