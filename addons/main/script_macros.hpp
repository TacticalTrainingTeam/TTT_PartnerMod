...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "ttt_pm_fnc_recompile") then {ttt_pm_recompiles = []; ttt_pm_fnc_recompile = {{call _x} forEach ttt_pm_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; ttt_pm_recompiles pushBack _recomp;
#else
